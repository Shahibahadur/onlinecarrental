...
public class PriceFactor implements Comparable<PriceFactor> {
    ...
    public String toString() {
        String changeType = isPriceIncrease() ? "increase" : isPriceDecrease() ? "decrease" : "neutral";
    ...
    public static class PriceFactorBuilder {
        ...
        public PriceFactorBuilder multiplier(BigDecimal multiplier) {
        ...
        public PriceFactorBuilder weight(BigDecimal weight) {
            this.weight = weight;
            return this;
        }
        ...
        public PriceFactorBuilder confidence(BigDecimal confidence) {
